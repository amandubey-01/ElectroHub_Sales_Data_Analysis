## Data Analysis for Online Store - ElectroHub
#### Data Source - Micrososft Excel Workbook containing sheets which have various dimensions table and a fact table. Dimension tables - Dim Customers, Dim Products, Dim Promotion. The visualisation is done by 
Power BI. It includes Power Query, DAX. Used joins to populate data in some columns. There are also derived columns by creating measures.
